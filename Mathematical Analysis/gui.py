...
import Lu as lu
import cramer as cr
window = tb.Window(themename='numanalysis')
...
def root():
    ...
    try:
        if cb1.get()=='False position':
            ...
            labelx = tb.Label(tab1,text=f"root {x2}",bootstyle="success",font=(12))
            labelx.grid(row=(10+len(iterations)),column=3,padx=(0,15),pady=2.5)
            ...
            for i in range(0,len(iterations)):
                ...
                labeli.grid(row=(8+i),column=3,padx=(0,15))
                iterations_lable.append(labeli)
            labelx = tb.Label(tab1,text=f"root {xk}",bootstyle="success",font=(12))
            labelx.grid(row=(10+len(iterations)),column=3,padx=(0,15),pady=2.5)
            ...
            for i in range(0,len(iterations)):
                ...
                iterations_lable.append(labeli)   
            labelx = tb.Label(tab1,text=f"root {xs}",bootstyle="success",font=(12))
            labelx.grid(row=(11+len(iterations)),column=3,padx=(0,15),pady=2.5)
...
def selected(event):
    if cb1.get() == 'False position' or cb1.get() == 'Bisection':
        ...
        x1.grid_forget()
        labelx1.grid_forget()
options = ['Bisection','False position','Newton Raphson','Simple fixed point','secant']
